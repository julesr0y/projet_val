...
void updateRameText(Text& text, vector<Rame>& tabRame, Rame rame, int pos_x, int pos_y); //fonction de mise à jour du texte du nombre de passagers dans les rames
